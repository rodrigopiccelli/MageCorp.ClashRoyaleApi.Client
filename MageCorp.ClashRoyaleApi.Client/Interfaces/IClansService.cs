...
public interface IClansService
{
    ...
    /// <param name="before">Return only items that occur before this marker. Before marker can be found from the response, inside the 'paging' property. Note that only after or before can be specified for a request, not both.</param>
    /// <returns></returns>
    ClanWarLog ListWarlog(string clanTag, int? limit = null, string? after = null, string? before = null);
    /// <summary>
    ...
    /// <param name="before">Return only items that occur before this marker. Before marker can be found from the response, inside the 'paging' property. Note that only after or before can be specified for a request, not both.</param>
    /// <returns></returns>
    ClanList Search(string? name = null, int? locationId = null, int? minMembers = null, int? maxMambers = null, int? minScore = null, int? limit = null, string? after = null, string? before = null);
    /// <summary>
    ...
    /// <param name="before">Return only items that occur before this marker. Before marker can be found from the response, inside the 'paging' property. Note that only after or before can be specified for a request, not both.</param>
    /// <returns></returns>
    RiverRaceLog ListRiverRaceLog(string clanTag, int? limit = null, string? after = null, string? before = null);
    /// <summary>
    ...
    /// <param name="clanTag">Tag of the clan.</param>
    /// <returns></returns>
    CurrentClanWar GetCurrentWar(string clanTag);
    /// <summary>
    ...
    /// <param name="before">Return only items that occur before this marker. Before marker can be found from the response, inside the 'paging' property. Note that only after or before can be specified for a request, not both.</param>
    /// <returns></returns>
    ClanMemberList ListMembers(string clanTag, int? limit = null, string? after = null, string? before = null);
    /// <summary>
    ...
    /// <param name="clanTag">Tag of the clan.</param>
    /// <returns></returns>
    CurrentRiverRace GetCurrentRiverRace(string clanTag);
}
